...
'@
    ...
    # REMOVED: Unused $serviceContent1 variable (was part of old multi-part approach)
    # Generate Trait Service implementation - Part 1 (Class structure)
    Write-InfoLog "Generating TraitService implementation - Part 1 (Core structure) - SKIPPED (using consolidated approach)"
...
'@
    ...
    # REMOVED: Unused $serviceContent3 variable (was part of old multi-part approach)
    # The following TypeScript code was moved inside the here-string above
    # All duplicate TypeScript code removed - now using consolidated approach
