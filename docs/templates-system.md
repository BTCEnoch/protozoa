...
**Key Principle:** _No script may emit inline code._ All source files originate from a template in `templates/`. Automation guarantees consistency, reduces duplication, and makes large-scale refactorings trivial (edit the template once → regenerate).
...
**Q:** _Can I bypass templates for a quick hot-fix?_  
**A:** No. Edit the template then regenerate – or your fix will be overwritten.

**Q:** _Can templates be nested?_  
