...
class RenderingService implements IRenderingService {
  ...
  public initialize(
    ...
    // Attach renderer canvas to parent container
    parentContainer.appendChild(this.#renderer.domElement)

    // Dependency injection
    this.#formationService = deps.formation
    this.#effectService = deps.effect

    this.#log.info('RenderingService initialized with dependencies', {
      hasFormation: !!deps.formation,
      hasEffect: !!deps.effect,
    })
  }
