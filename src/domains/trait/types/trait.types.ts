...
/**
 * Bitcoin block information structure
 */
...
export interface MutationProbability {
  /** Base mutation rate (0.0-1.0) */
  baseRate: number
  /** Modifier based on block activity */
...
/**
 * Trait range definition for numeric values
 */
export interface NumericTraitRange {
  /** Minimum value */
  min: number;
  /** Maximum value */
  max: number;
...
/**
 * Trait range definition for string values (like colors)
 */
export interface StringTraitRange {
  /** Minimum value */
  min: string;
  /** Maximum value */
  max: string;
...
/**
 * Union type for all trait ranges
 */
export type TraitRange = NumericTraitRange | StringTraitRange;
