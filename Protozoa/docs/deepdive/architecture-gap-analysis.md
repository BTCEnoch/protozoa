...
*Use this as the authoritative backlog.  Each unchecked item must eventually map to either:*
...
|15 | Compliance | Verify scripts update to assert *worker.terminate()* on dispose | 🔲 |
...
- ☑ **Basic service present** but **missing**:
  - 🔲 *rehash chain* & `maxChainLength` guard.
...
*(Full script templates to be authored after checklist approval.)*
